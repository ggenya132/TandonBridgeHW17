            ...
            if (curr_node->parent == curr_node->parent->parent->left) {
                ...
                if (getColor(uncle) == RED) {
                    ...
                    if (curr_node == curr_node->parent->right) {
                        // Case 2: Uncle is BLACK and curr_node is a right child
                        curr_node = curr_node->parent;
                        singleCCR(curr_node);
                    }
                    // Case 3: Uncle is BLACK and curr_node is a left child
                    swapColor(curr_node->parent);
                    swapColor(curr_node->parent->parent);
                ...
                if (getColor(uncle) == RED) {
                    ...
                    if (curr_node == curr_node->parent->left) {
                        // Case 2: Uncle is BLACK and curr_node is a left child
                        curr_node = curr_node->parent;
                        singleCR(curr_node);
                    }
                    // Case 3: Uncle is BLACK and curr_node is a right child
                    swapColor(curr_node->parent);
                    swapColor(curr_node->parent->parent);
